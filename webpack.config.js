...
module.exports = {
  ...
  output: {
    ...
    path: '.webpack',
    filename: 'lambda.js', // this should match the first part of function handler in serverless.yml
  },
  externals: ['sharp', 'phantomjs', 'aws-sdk'],
  plugins: [
    ...
    //new ExtractTarballPlugin('lib/phantomjs-XXXX-linux-x64.tar.gz', '.webpack/'),
  ],
}
